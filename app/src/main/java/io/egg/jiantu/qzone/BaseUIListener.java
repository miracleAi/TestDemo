	...
	private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case ON_COMPLETE:
                ...
                TencentUtil.showResultDialog(mContext, response.toString());
                TencentUtil.dismissDialog();
                break;
            case ON_ERROR:
                UiError e = (UiError)msg.obj;
                TencentUtil.showResultDialog(mContext, "错误: " + e.errorMessage);
                TencentUtil.dismissDialog();
                break;
            case ON_CANCEL:
				Toast.makeText((Activity)mContext,"onCancel", Toast.LENGTH_SHORT).show();
                break;
            }
        }	    
	};
